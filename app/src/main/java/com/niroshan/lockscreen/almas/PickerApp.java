...
public class PickerApp extends ActionBarActivity {
    ...
    protected void onCreate(Bundle RainOfNiro) {
        ...
        SharedPreferences sp = getSharedPreferences("NiroPicker", Context.MODE_PRIVATE);
        ...
        if (DEBUG) {
            ...
            if (CurGet == null | CurGet == "") {
                ...
                Log.e(TAG_NAME, "This is First View of NiroPicker");
