...
import com.niroshan.lockscreen.lockerstable.LockerService;
import com.niroshan.lockscreen.lockerstable.PinActivity;
    ...
    public ShortcutView(final Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < CAPACITY; i++) {
            ...
            if (s == null | s == "") {
                ...
                Settings.System.putString(context.getContentResolver(), "PiSC" + b, "com.niroshan.lockscreen.lockerstable");
            }
            sv = s;
