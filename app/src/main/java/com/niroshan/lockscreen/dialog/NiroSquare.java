...
public class NiroSquare extends View {
	Paint paint;
	Shader luar;
	final float[] color = { 1.f, 1.f, 1.f };

	public NiroSquare(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public NiroSquare(Context context, AttributeSet attrs, int defStyle) {
