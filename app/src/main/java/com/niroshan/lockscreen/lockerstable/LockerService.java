...
public class LockerService extends Service {
    ...
    public void onCreate() {
        ...
        mStatus = Settings.System.getInt(getBaseContext().getContentResolver(), "Locker", 0);
        ...
        if (mStatus == 1) {
            ...
            try {
                ...
                mKeyguardLock = ((KeyguardManager) getSystemService(Context.KEYGUARD_SERVICE)).newKeyguardLock("Locker");
        ...
        try {
            ...
            registerReceiver(mRestore, new IntentFilter("com.niroshan.lockscreen"));
