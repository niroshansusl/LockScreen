package com.niroshan.lockscreen.widget;
...
public class NiroPreference extends Preference {
	private final boolean supportsAlpha;
	int value;

	public NiroPreference(Context context, AttributeSet attrs) {
		super(context, attrs);

		final TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.NiroPreference);
		supportsAlpha = ta.getBoolean(R.styleable.NiroPreference_supportsAlpha, false);

		setWidgetLayoutResource(R.layout.niro_pref_widget);
	}
	...
	protected void onBindView(View view) {
		...
		final View box = view.findViewById(R.id.niro_pref_widget_box);
		if (box != null) {
	...
	protected void onClick() {
		new NiroDialog(getContext(), value, supportsAlpha, new NiroDialog.OnNiroListener() {
			@Override
